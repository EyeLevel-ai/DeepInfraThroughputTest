"""
LLM Load Tester → CSV Logger (Kvant 4B Endpoint)
...
ENDPOINT = "https://summary-api-eyelevel.apps.eyelevel.kvant.cloud/chat/completions"
STREAM = False  # no stream on this API

CSV_FILE = "llm_load_results_selfhost.csv"
...
class LLMStressTest:
    ...
    async def run(self):
        print(f"🚀 Starting Kvant 4B load test (ramp {RAMP_RATE}/s → max {MAX_CONCURRENCY})")
        init_csv()
